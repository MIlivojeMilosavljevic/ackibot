...
//RCLCPP_INFO(nh_->get_logger(), "wheel_l = %f", wheel_l);
//RCLCPP_INFO(nh_->get_logger(), "wheel_r = %f", wheel_r);
...
//RCLCPP_INFO(nh_->get_logger(), "wheels_separation_ = %f", wheels_separation_);
    theta = wheels_radius_ * (wheel_r - wheel_l) / wheels_separation_;
//RCLCPP_INFO(nh_->get_logger(), "theta = %f", theta);
    delta_theta = theta;
  }
//RCLCPP_INFO(nh_->get_logger(), "delta_theta = %f", delta_theta);
